...

{
    ...
    public float IntoTheGround { get{ return intoGround; } }
    ...
    public void CreateUnitCompleted()
    {
        ...
        GameObject unitObj = Instantiate(faction.UnitPrefabs[id], spawnPoint.position, Quaternion.Euler(0f, 0f, 0f),faction.UnitsParent);
